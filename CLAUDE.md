...
EZAgent42 是 Programmable Organization OS——基于 CRDT 的组织操作系统。人类和 AI Agent 作为平等参与者，在同一个协作空间里共同运作组织。
...
| [`page/`](page/CLAUDE.md) | 官网 (ezagent.cloud) | Astro, GitHub Pages | [page/CLAUDE.md](page/CLAUDE.md) |
...
- **docs/plan/** — 实施计划（Phase 0–6）
- **docs/specs/** — 协议规范（architecture, bus, extensions, socialware, py-sdk, relay, repo）
- **docs/eep/** — EEP 设计提案（ezagent Enhancement Proposal，协议演进治理流程）
